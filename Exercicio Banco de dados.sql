...
select count(*) FROM funcionarios; /* Listar a quantia de dados inseridas no banco de dados */ 
...
/* Neste comando, é apresentado uma tabela onde os funcionários estarão agrupados por seus respectivos departamentos e ordem com base no count(*) */

/* Exercicio 01 

	Apresentar os funcionarios que trabalham 
...
/* Neste caso, é interessante colocar o maior número primeiro */

/* Este comando irá apresentar todos os funcionarios que trabalham nos departamentos selecionados, no caso Roupas e Filmes. */



/* Exercicio 02 
	Listar AS FUNCIONARIAS (FEMININO) que trabalham no departamento de filmes ou no departamento de lar. 

*/

/* 491 mulheres no banco de dados */
SELECT COUNT(*), sexo
from funcionarios
group by sexo;

/* 52 no lar e 21 filmes */
SELECT COUNT(*), departamento
from funcionarios
group by departamento;


/*COM O COMANDO AND É MELHOR colocar o menor numero de ocorrencias em primeiro, para evitar checar o banco de dados mais vezes */

SELECT * FROM funcionarios 
where 
(DEPARTAMENTO = 'lar' AND sexo ='Feminino') /* COLOCAR ENTRE OS PARENTESES, PARA SELECIONAR AS 2 CONDIÇÕES DEPARTAMENTOS E SEXO
OR 
...
EXERCICIO 03
SELECIONA OS FUNCIONARS MASCULINOS OU OS FUNCIONARIOS QUE TRABALHAM NO SETOR Jardim
